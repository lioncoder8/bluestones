<?php
/**
 * Class Name: aasta_bootstrap_navwalker
 ...
 */
class aasta_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li class="menu-item"><a class="nav-link add-menu" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html__( 'Add a menu', 'aasta' ) . '</a></li>';
			$fb_output .= '</ul>';
