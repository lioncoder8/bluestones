...
/**
 * Class Aasta_Customize_Radio_Buttonset_Control
 */
class Aasta_Customize_Radio_Buttonset_Control extends Aasta_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'aasta-radio-buttonset';
