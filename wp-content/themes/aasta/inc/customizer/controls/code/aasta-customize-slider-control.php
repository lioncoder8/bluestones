...
/**
 * Class Aasta_Customize_Slider_Control
 */
class Aasta_Customize_Slider_Control extends Aasta_Customize_Base_Control {
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			<div class="aasta-slider">
				<div id="custom-handle" class="ui-slider-handle"></div>
			</div>
			<div class="aasta-slider-input">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span
							class="screen-reader-text"><?php esc_html_e( 'Reset', 'aasta' ); ?></span></span>
			</div>
		</div>
