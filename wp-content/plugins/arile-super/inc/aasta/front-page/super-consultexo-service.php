...
$aasta_service_area_title = get_theme_mod('aasta_service_area_title', __('Why Choose Us','arile-super'));
$aasta_service_area_des = get_theme_mod('aasta_service_area_des', __("We provide the world's best consulting-related services to growth your business.",'arile-super'));
		...
		foreach ( $aasta_service_content as $features_item ) {
			...
			{ ?>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						<figure class="service-content-thumbnail text-center">
							<a href="#"><img class="img-fluid" src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-service7.jpg" alt="SEO Friendly" title="SEO Friendly"></a>
						</figure>
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('Corporate Finance','arile-super'); ?></a></h5>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						<figure class="service-content-thumbnail text-center">
							<a href="#"><img class="img-fluid" src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-service8.jpg" alt="Translation & RTL Ready" title="Translation & RTL Ready"></a>
						</figure>
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('Consulting Service','arile-super'); ?></a></h5>
						<p class="text-center"><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>		
					</article>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						<figure class="service-content-thumbnail text-center">
							<a href="#"><img class="img-fluid" src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-service9.jpg" alt="Creative Design" title="Creative Design"></a>
						</figure>
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('Market Analysis','arile-super'); ?></a></h5>
						<p class="text-center"><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>
					</article>
				</div>
