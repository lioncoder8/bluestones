...
$aasta_project_area_title = get_theme_mod('aasta_project_area_title', __('Our latest works','arile-super'));
$aasta_project_area_des = get_theme_mod('aasta_project_area_des', __('Our Projects','arile-super'));
			...
			<div class="row theme-project-row">		
				...
				<?php } } else { ?>
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project1.jpg" class="img-fluid" alt="StartUp business">
										<div class="content-overlay"></div>
										<div class="click-view">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project2.jpg" class="img-fluid" alt="Market expansion">
										<div class="content-overlay"></div>
										<div class="click-view">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project3.jpg" class="img-fluid" alt="Data analytics">
										<div class="content-overlay"></div>
										<div class="click-view">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project8.jpg" class="img-fluid" alt="Internet marketing">
										<div class="content-overlay"></div>
										<div class="click-view">
										<h5 class="theme-project-title"><?php esc_html_e('Internet marketing','arile-super'); ?></h5>
										</div>
									</figure>
								</article>
							</div>	
