...
<section class="theme-main-slider" id="theme-slider">
	...
	<?php 
		...
		if('Architect Studio' == $activate_theme) {?>
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide11.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-center theme-caption-bg align-center">
					    <h5 class="sub-title"><?php esc_html_e('EFFECTIVE SOLUTIONS','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('BEST ARCHITECT DESIGN','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('We provide all types of architecture and interior design services such as exterior design, house design, kitchen design, room design, furniture design, light design, etc. With the help of which you can build your dream home.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide12.jpg">
				<div class="container theme-slider-content">
					<div class="theme-text-center theme-caption-bg align-center">
