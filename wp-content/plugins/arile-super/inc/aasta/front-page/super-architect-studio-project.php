...
$aasta_project_area_title = get_theme_mod('aasta_project_area_title', __('ALL ARCHITECTURE DESIGN SOLUTIONS','arile-super'));
			...
			<div class="row theme-project-row">		
				...
				<?php } } else { ?>
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project9.jpg" class="img-fluid" alt="HOME RENOVATIONS">
										<div class="content-overlay"></div>
										<div class="click-view">
										<h5 class="theme-project-title"><?php esc_html_e('HOME RENOVATIONS','arile-super'); ?></h5>
										</div>
									</figure>
								</article>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project10.jpg" class="img-fluid" alt="EXTERIOR RENOVATION">
										<div class="content-overlay"></div>
										<div class="click-view">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project11.jpg" class="img-fluid" alt="ARCHITECTURE DESIGN">
										<div class="content-overlay"></div>
										<div class="click-view">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project12.jpg" class="img-fluid" alt="INTERIOR DESIGN">
										<div class="content-overlay"></div>
										<div class="click-view">
										<h5 class="theme-project-title"><?php esc_html_e('INTERIOR DESIGN','arile-super'); ?></h5>
										</div>
									</figure>
								</article>
							</div>	
