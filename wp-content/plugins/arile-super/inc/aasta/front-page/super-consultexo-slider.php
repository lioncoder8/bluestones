...
<section class="theme-main-slider vrsn-three" id="theme-slider">
    <div id="theme-main-slider" class="owl-carousel owl-theme">
		<?php 
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide8.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
					    <h5 class="sub-title"><?php esc_html_e('Best Business Advisors','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('Get A Free Consultation','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e("We provide the world's best finance and consulting services to grow your business, so contact us and see the results quickly.",'arile-super'); ?></p>
						<div class="mt-3 pt-3">
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide9.jpg">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
					    <h5 class="sub-title"><?php esc_html_e('Strategies for Enduring Success','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('We help to get solutions','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e("We provide the world's best finance and consulting services to grow your business, so contact us and see the results quickly.",'arile-super'); ?></p>
						<div class="mt-3 pt-3">
							<a href="#" class="btn-slider"><?php esc_html_e('Check it out','arile-super'); ?></a>
						</div>							
