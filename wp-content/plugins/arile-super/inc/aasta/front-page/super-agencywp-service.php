...
$aasta_service_area_title = get_theme_mod('aasta_service_area_title', __('We offer many services to growth','arile-super'));
$aasta_service_area_des = get_theme_mod('aasta_service_area_des', __('Our Features','arile-super'));
						...
						<div class="media-body">
							<?php if ( ! empty( $title ) ) : 
								if(empty($link)){ ?>
									...
									?>
									<h5 class="service-title"><a href="<?php echo esc_url( $link ); ?>" <?php if($open_new_tab =='yes'){?>target="_blank" <?php }?> ><?php echo esc_html( $title ); ?></a></h5><?php
								}
							?>
							<?php endif; ?>
							<?php if ( ! empty( $text ) ) : ?>
			...
			{ ?>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content-two media wow animate fadeInUp" data-wow-delay=".3s">
						...
						<div class="media-body">
							<h5 class="service-title"><a href="#"><?php esc_html_e('SEO Friendly','arile-super'); ?></a></h5>
							<p><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>
						</div>
					</article>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content-two media wow animate fadeInUp" data-wow-delay=".3s">
						...
						<div class="media-body">
							<h5 class="service-title"><a href="#"><?php esc_html_e('Translation','arile-super'); ?></a></h5>
							<p><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>
						</div>
					</article>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content-two media wow animate fadeInUp" data-wow-delay=".3s">
						...
						<div class="media-body">
							<h5 class="service-title"><a href="#"><?php esc_html_e('Creative Design','arile-super'); ?></a></h5>
							<p><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>
						</div>
					</article>
				</div>
