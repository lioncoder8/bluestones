...
<section class="theme-main-slider vrsn-three" id="theme-slider">
    <div id="theme-main-slider" class="owl-carousel owl-theme">
		<?php 
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide13.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
						<h1 class="title-large"><?php esc_html_e('We Provide Innovative Business Services','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('We provide all types of business solutions and services to our valuable customers for the growth of their businesses to the next level.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide14.jpg">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
