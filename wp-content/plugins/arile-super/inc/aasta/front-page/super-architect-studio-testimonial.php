...
$aasta_testimonial_area_title = get_theme_mod('aasta_testimonial_area_title', __('WHAT OUR CLIENTS SAY ABOUT US','arile-aasta'));
$aasta_testimonial_area_des = get_theme_mod('aasta_testimonial_area_des', __('Our Testimonials','arile-aasta'));
$aasta_testimonial_overlay_disable = get_theme_mod('aasta_testimonial_overlay_disable', true); 
if($aasta_testimonial_disabled == true): 
?>
<section class="theme-block theme-testimonial vrsn-three" id="theme-testimonial">	
